...
# If using a passphrase-protected key and a passphrase is provided,
# load the key into an ssh-agent non-interactively.
...
EOF
    ...
    # Force askpass even without a tty.
...
echo ""
echo "🔍 Check your site: https://bazaars.io"
echo "📊 API endpoint: https://bazaars.io/api/info"
echo "❤️  Health endpoint: https://bazaars.io/api/health"
echo ""
