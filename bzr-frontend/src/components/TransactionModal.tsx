  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/30 backdrop-blur-sm overflow-y-auto">
      <div className="flex min-h-full items-end sm:items-center justify-center p-0 sm:p-4 lg:p-6">
        ...
        <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-3 sm:mb-4 pr-8">Transaction Details</h3>
        ...
        <div className="space-y-3 sm:space-y-4">
          ...
          <div className="grid gap-3 sm:gap-4">
            ...
            <DetailRow 
              ...
              link={getExplorerUrl(transaction.chainName, transaction.from, 'address')}
              copyable 
            />
            <DetailRow 
              label="To" 
              value={transaction.to} 
              link={getExplorerUrl(transaction.chainName, transaction.to, 'address')}
              copyable 
            />
