...
export const TokenOverviewHeader = () => {
  ...
  if (loadingInfo && !tokenPrice) {
    return <div className="w-full h-64 bg-gray-100 animate-pulse rounded-xl mb-8" />;
  }
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white rounded-xl border border-gray-200 shadow-sm p-0 overflow-hidden">
          ...
          <div className="p-6 grid gap-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 pb-6 border-b border-gray-100">
              <div>
                <div className="text-xs text-gray-500 uppercase tracking-wide mb-1">BZR PRICE</div>
                <div className="flex items-baseline gap-2">
                  <span className="text-2xl font-bold text-gray-900">{formatUsdValue(price)}</span>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-8">
              <div className="flex justify-between sm:block">
                <span className="text-sm text-gray-500 block mb-1">Total Supply:</span>
                <span className="font-medium text-gray-900">
                  {totalSupply.toLocaleString()} BZR
                </span>
              </div>
              
              <div className="flex justify-between sm:block">
                <span className="text-sm text-gray-500 block mb-1">Circulating Supply:</span>
              ...
              <div className="flex justify-between sm:block">
                <span className="text-sm text-gray-500 block mb-1">Holders:</span>
                <span className="font-medium text-gray-900">
              ...
              <div className="flex justify-between sm:block">
                <span className="text-sm text-gray-500 block mb-1">Total Transfers:</span>
                <span className="font-medium text-gray-900">
                  {transfersTotals?.allTimeTotal?.toLocaleString() || '...'}
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="lg:col-span-1 bg-white rounded-xl border border-gray-200 shadow-sm p-0 overflow-hidden flex flex-col">
          ...
          <div className="p-6 flex-1 space-y-6">
            ...
            {/* Official Site */}
            <div>
              <div className="text-xs text-gray-500 uppercase tracking-wide mb-2">Official Site</div>
              <a 
            ...
            {/* Socials */}
            <div>
              <div className="text-xs text-gray-500 uppercase tracking-wide mb-3">Social Profiles</div>
